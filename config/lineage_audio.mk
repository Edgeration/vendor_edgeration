...
ALARM_PATH := vendor/edgeration/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/edgeration/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/edgeration/prebuilt/common/media/audio/ringtones
